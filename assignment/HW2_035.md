...
5.) จากกลุ่มตัวอย่าง Survey พบว่ามีคนที่สูบบุหรี่หนักๆอยู่ 11 คน สูบเป็นประจำอยู่ 17 คน สูบเป็นบางครั้งอยู่ 19 คน ไม่เคยสูบอยู่ 189 คน 
และไม่ระบุตัวตน 1 คน
```{R}
